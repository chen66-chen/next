...
try {
  ...
  console.log('成功直接写入HTTP.json文件，使用UTF-8编码！');
  
  // 为了确保成功，我们再检查一下写入的文件内容
  const readContent = fs.readFileSync('../data/posts/HTTP.json', 'utf8');
  console.log('检查文件是否包含中文字符：', readContent.includes('协议') ? '成功' : '失败');
} catch (error) {
