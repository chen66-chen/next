      ...
      <div className="mb-12">
        ...
        <Tabs defaultValue="style1" className="max-w-3xl mx-auto">
          <TabsList className="grid w-full grid-cols-3">
            ...
            <TabsTrigger value="style2" className="font-['NotoSerifSC']">小臣のWeb风格</TabsTrigger>
      ...
      <div className="max-w-3xl mx-auto mt-16">
        ...
        <Tabs defaultValue="style1" className="mb-8">
          <TabsList className="grid w-full grid-cols-3">
            <TabsTrigger value="style1" className="font-['KuaiKanShiJieTi']">技术风格</TabsTrigger>
            <TabsTrigger value="style2" className="font-['NotoSerifSC']">小臣のWeb风格</TabsTrigger>
            <TabsTrigger value="style3" className="font-['HanTang']">小臣小窝an'q</TabsTrigger>
          </TabsList>
          <TabsContent value="style1" className="mt-6">
            <FAQAccordion items={faqItems} style="style1" />
          </TabsContent>
          <TabsContent value="style2" className="mt-6">
            <FAQAccordion items={faqItems} style="style2" />
          </TabsContent>
          <TabsContent value="style3" className="mt-6">
      ...
      <div className="max-w-3xl mx-auto mt-16 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="p-4 rounded-lg bg-slate-100">
            ...
            <p className="text-muted-foreground">contact@blog-fusion.com</p>
          </div>
          <div className="p-4 rounded-lg bg-slate-100">
            <div className="text-3xl mb-2">💬</div>
            <h3 className="font-medium mb-1">社交媒体</h3>
            <p className="text-muted-foreground">@BlogFusion</p>
          </div>
          <div className="p-4 rounded-lg bg-slate-100">
            <div className="text-3xl mb-2">🏢</div>
